;(function ($, document, window, undefined) {
			...
			for (var i = 0; i < length; i++) {
				...
				if (instance[el].options.showThumb === true) {
					...
					if (instance[el].options.multiUpload === false) {
						row = '<tr class="fileupload-previewrow thumb row" id="' + fileName + '"><td class="col-lg-4">' + thumb + '</td><td class="col-lg-4">' + file.name + '</td><td class="col-lg-4"><button class="btn btn-danger fileupload-remove" value="' + fileName + '"><i class="glyphicon glyphicon-ban-circle"></i>&nbsp;<span>Remove File</span></button></td></tr>';
					} else {
						row = '<tr class="fileupload-previewrow thumb row" id="' + fileName + '"><td class="col-lg-4">' + thumb + '</td><td class="col-lg-9">' + file.name + '</td><td class="col-lg-2"><button class="btn btn-danger fileupload-remove" value="' + fileName + '"><i class="glyphicon glyphicon-ban-circle"></i>&nbsp;<span>Remove File</span></button></td></tr>';
					}
				} else {
					if (options.multiUpload === false) {
						row = '<tr class="fileupload-previewrow no-thumb row" id="' + fileName + '"><td class="col-lg-5">' + file.name + '</td><td class="col-lg-6">' + progressBar + '</td><td class="col-lg-4"><button class="btn btn-danger fileupload-remove" value="' + fileName + '"><i class="glyphicon glyphicon-ban-circle"></i>&nbsp;<span>Remove File</span></button></td></tr>';
					} else {
	...
	function startup (el) {
		...
		*/
		availableFileTypes["images"] = ["gif", "jpeg", "jpg", "png"];
	...
	function formStructure (el) {
		...
		instance[el].btnStart = $('<button class="btn btn-warning fileupload-start hidden"><i class="glyphicon glyphicon-upload"></i>&nbsp;<span>Start upload</span></button>');
		instance[el].btnCancel = $('<button type="reset" class="btn btn-danger fileupload-cancel hidden"><i class="glyphicon glyphicon-ban-circle"></i>&nbsp;<span>Cancel upload</span></button>');
	...
	function genThumb (el, file, fileType, fileExt) {
		...
		switch (fileType) {
			...
			case 'files':
				...
				break;
			case 'images':
				thumb = '<img src="' + URL.createObjectURL(file) + '" alt="' + file.name + '" class="img img-fluid img-responsive" height="' + instance[el].options.thumbHeight + 'px" class="fileupload-previewimg" />';
