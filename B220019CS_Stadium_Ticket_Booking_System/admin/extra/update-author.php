<?php require_once"db/session.php";
	...
	extract(mysqli_fetch_array(select("select * from author where author_id='".$_REQUEST['author_id']."'")));
?>
<!DOCTYPE HTML>
<html>
	<head>
					...
					<div class="grid-form">
						<div class="grid-form1">
							...
							<div class="panel-body">
								<form class="form-horizontal"  method="post" id="update_author" action="ajax/user.php" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">
												...
												<input type="text" class="form-control1 myform" name="author_name"  value="<?=ucwords($author_name)?>"  id="author_name" placeholder="Author Name"/>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">
												...
												<select name="category" id="category" class="form-control1 myform" >
													...
													<?php $res = select("select * from category"); while($categories = mysqli_fetch_array($res)){ ?>
														<option value="<?=$categories['cat_id']?>"  <?php if($cat_id==$categories['cat_id']) echo "selected";  ?>><?=ucwords($categories['category_name'])?></option>
													<?php } ?>
												</select>
											</div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">
												...
												<input type="text" class="form-control1 myform" name="detail1" value="<?=ucwords($detail1)?>"  id="detail1" placeholder="Detail 1 Here"/>
												<input type="hidden" name="author_id" value="<?=$author_id?>"  readonly="readonly"/>
											</div>
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-8">
											<div class="input-group">
												...
												<input type="text" class="form-control1 myform"  name="detail2" value="<?=ucwords($detail2)?>"  id="detail2" placeholder="Detail 2 Here"/>
											</div>
										</div>
									</div>
									<div class="sign-u text-center">
										<img src="author/<?=$image?>" style="width: 250px;">
